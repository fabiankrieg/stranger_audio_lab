class StrangerEnsemble:
    ...
    Subclassing:
        Subclasses should override the methods to implement custom behavior for managing
        the ensemble, parts, and update intervals.
...
class StrangerBPMEnsemble(StrangerEnsemble):
    ...
    def __init__(self, bpm, max_division):
        """
        Initializes the StrangerBPMEnsemble with BPM and max division.
